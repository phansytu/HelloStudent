...
namespace src
{
    public class MonHocManager
    {
        ...
        public List<MonHoc> DanhSachMonHocGoc { get; private set; } = new List<MonHoc>();
        ...
        public void NhapMonHoc()
        {
            ...
            while (true)
            {
                ...
                if (DanhSachMonHocGoc.Exists(m => m.TenMon.Equals(tenMon, StringComparison.OrdinalIgnoreCase)))
                {
            ...
            DanhSachMonHocGoc.Add(monHocMoi);
        ...
        public void HienThiDanhSachMon()
        {
            ...
            for (int i = 0; i < DanhSachMonHocGoc.Count; i++)
            {
                var m = DanhSachMonHocGoc[i];
